...
var markeeFooter2 = function(){
        ...
        let flickity = null;
        let isPaused = false;
        const slideshowEl = document.querySelector('.footer-carousel-2');
...
var markeeFooter3 = function(){
        ...
        let flickity = null;
        let isPaused = false;
        const slideshowEl = document.querySelector('.footer-carousel-3');
...
if (!isMobile()) { */
    ...
    if( !$('body').hasClass('page--map')){
        markeeFooter();markeeFooter2();markeeFooter3();
    };
